---
slug: /prompt-engineering/openai/intro
position: 2
---
...
1️⃣ [清晰的指令](/technique/prompt-engineering/openai/01)

2️⃣ [引用内容](/technique/prompt-engineering/openai/02)

3️⃣ [将复杂任务拆分成简单任务](/technique/prompt-engineering/openai/03)

4️⃣ [给模型多点时间去思考](/technique/prompt-engineering/openai/04)

5️⃣ [使用第三方的工具](/technique/prompt-engineering/openai/05)

6️⃣ [系统性测试变化](/technique/prompt-engineering/openai/06)
